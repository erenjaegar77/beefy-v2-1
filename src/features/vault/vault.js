...
import DisplayTags from '../../components/vaultTags/vaultTags';
import {ArrowLeft, HelpOutline, ShoppingBasket} from '@material-ui/icons';

const useStyles = makeStyles(styles);
const chartData = [
    {name: '28 Jan', apy: 45.0},
    {name: '4 Feb', apy: 57.15},
    {name: '11 Feb', apy: 38.5},
                        ...
                        <Grid className={classes.title} container>
                            <Grid>
                                <Avatar
                                    ...
                                    alt={vault.name}
                                    src={require('../../images/' + vault.logo).default}
                            ...
                            {dw === 'deposit' ? (
                                <React.Fragment>
                                    <Box p={3}>
                                        ...
                                        >
                                            ...
                                            <Box flexGrow={1} pl={1}>
                                                <Typography variant={'body1'}>
                                                    {vault.balance} {vault.token}
                                                </Typography>
                                            </Box>
                                            <Box>
                                                <Button endIcon={<ShoppingBasket />}>
                                                    Buy Token
                                                </Button>
                                            </Box>
                                        </Box>
                                        ...
                                        <Box mt={2}>
                                            <Button className={classes.btnDeposit} fullWidth={true}>
                                                Deposit
                                            </Button>
                                        </Box>
                                        <Box mt={2}>
                                            <Button
                                                className={classes.btnPurchaseDeposit}
                                                fullWidth={true}
                                            >
                                            ...
                                            <Box display="flex" alignItems="center">
                                                <Box lineHeight={0}>
                                                    <img
                                                        alt={vault.name}
                                                        src={
                                                            require('../../images/fire.png').default
                                                        }
                                                    />
                                                </Box>
                                                <Box>
